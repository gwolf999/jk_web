...
try {
	...
	if (c) {
		...
		rtc =  new Array();
rtc[0] = [80426, 'http://sync.search.spotxchange.com/partner?adv_id=7183&img=1&uid=USERTOKEN', 7];	// 
rtc[1] = [4700, 'http://d1.zedo.com/rs/us/fcm.html?pid=4&usr=', 7];	// 
rtc[2] = [3387, 'http://sync.adaptv.advertising.com/sync?type=gif&key=valueclickinc&uid=USERTOKEN', 7];	// 
rtc[3] = [14000, 'http://cm.g.doubleclick.net/pixel?dtm_ghm&google_nid=dotomi&google_sc&google_ula=17128&google_hm=USERTOKEN ', 7];	// 
rtc[4] = [1982, 'http://ib.adnxs.com/setuid?entity=34&code=USERTOKEN', 7];	// 
rtc[5] = [19998, 'http://r.casalemedia.com/rum?cm_dsp_id=65&external_user_id=USERTOKEN', 7];	// 
rtc[6] = [60, 'http://ums.adtechus.com/mapuser?providerid=1013;userid=USERTOKEN', 7];	// 
...
rtc[13] = [1988, 'http://pix.btrll.com/partner/692277.png', 7];	// 
